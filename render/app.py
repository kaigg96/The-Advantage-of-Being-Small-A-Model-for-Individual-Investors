...
# 3a. load data
small_cap_price_data = pd.read_hdf('price-data/small_cap_price_data.h5')
closing_price_data = pd.read_hdf('price-data/closing_price_data.h5')
high_price_data = pd.read_hdf('price-data/high_price_data.h5')
low_price_data = pd.read_hdf('price-data/low_price_data.h5')
